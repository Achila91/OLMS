	...
	<header class="container">
		...
		<section class="content">
			...
			<div class="login">
				...
				<br>
				<center><img src="images/logo.jpg" width="306"></center>




				<h3 style="color:#900;"><?PHP if (isset($_SESSION['successstatus'])) {
											echo $_SESSION['successstatus'];
										} ?></h3>
				...
				<form method="post" action="" style="padding:10px;">
					...
					<h3>
						<div align="center" style="color:white; font-size:16px; "><?php echo $error; ?></div>
					</h3>

					<button class="btn-large" style="background-color:#B60A21;width:100%; " onclick="location.href = 'inside/Lecture/login.php';"><i class="fa fa-sign-in" aria-hidden="true"></i>>> Lecturer Login </button>
