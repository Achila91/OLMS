			...
			$rdt = '<div class="container" id="c">
																	  ...
																	  <div class="panel-group">
																		...
																		<div class="form-group">
																		  ...
																		  <p style="color:red;">(  4 - Assistant Accountant | 3 - Accountant | 2 - Branch Manager | 1 - Top Level )</p>
...
<body>
	...
	<div class="frmSearch">
		...
		<form action="index.php?tab=manage_admin" method="post" enctype="multipart/form-data">
			...
			<table style="width:850px auto;" border="0" align="center" cellpadding="10" cellspacing="10">
				<tr>
					<td width="218" bgcolor="#FFFFFF">
						<div style="border-style: dashed;width:auto; border-color: #F00; padding:10px;"><br>
							<label>jpg | png</label><input type='file' class="btn btn-warning" name="file1" id="file1" onChange="readURL(this);">
							<br>
							<p align="center"><img src="Admin/M_ADMIN/user.png" alt="your image" width="100px" class="img-thumbnail" id="pimg" /></p>
						</div>
					</td>
					<td width="231" align="center" valign="top" bgcolor="#FFFFFF" style="padding:10px;">
						<div class="form-group">
					...
					<td width="280" align="center" valign="top" bgcolor="#FFFFFF" style="padding:10px;">
						<div class="form-group">
							<label>Branch</label>
							<br>
							<?php
							...
							if (mysqli_num_rows($sql)) {
								$select = '<select id="branch" class="form-control" name="b"><option selected disabled>Select Branch</option>';
						...
						<div class="form-group">
							<p>
								...
								<option value="" disabled selected>Select Level</option>	
									...
									<option value="4">Assistant Accountant</option>
						...
						<div class="form-group">
							...
							<p align="center" style="font-size:16px; font-family:Georgia, 'Times New Roman', Times, serif; font-style:italic;  "><u>Default password is :<span style="color:#F00;"> ectc</span> </u></p>
							</p>
						</div>
			...
			<br>
			<br>
			<p align="center"> <button type="submit" class="btn btn-primary  btn-lg" name="crteusr"><span class="glyphicon glyphicon-user"></span> Add User</button></p>
		</form>
    ...
    <a href="javascript:delete_records(' . $row["admin_id"] . ')"><button type="button" class="btn btn-danger" style="width:50%;">Delete User</button></a><br/>
</td><br></tr>';
				}
		...
		<script type="text/javascript">
			function delete_records(intValue) { //alert(intValue);
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">System Needs Authentication!</h4>
					</div>
					<div class="modal-body">
