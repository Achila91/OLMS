 ...
 <div class="content-wrapper">
    ...
    <?php
                                    ...
                                    // $ret=mysqli_query($con,"select SEC_TO_TIME(SUM(TIME_TO_SEC(t.to_time))) as total, c.*, l.rem_pay from t_time t, c_assign c, lec_pay l where MONTH(t.rdate)='$month' and YEAR(t.rdate)='$year' and t.as_id=$id and c.id=t.as_id and l.as_id=t.as_id and t.approval='Approved' and l.pay_month='$month' and l.pay_year='$year'");
                                                                    $ret=mysqli_query($con,"select SUM(t.to_time) as total, c.l_name, c.c_name, c.rate, c.course from t_time t, c_assign c where YEAR(t.rdate)='$year' and MONTH(t.rdate)='$month' and t.as_id=$id and t.approval='Approved' and c.id=t.as_id");
                                    ...
                                    ?>
  <fieldset>
  <h3 class="" style="padding-left:10%">Lecture Coverages</h3><br><br>
...
<table class="table table-striped table-bordered" id="" width="50%" align="center" cellspacing="0">
            <thead>
                <tr>
            ...
            <input type="button" class="btn btn-danger" onclick="location.href='../index.php?tab=finalize';" value="Back" style="background-color:#003366; color:#fff; margin-left:5%;margin-bottom:5%"/>
