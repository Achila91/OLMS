				...
				<table align="center">
					...
					<tr>
						...
						<td>
							...
							if (mysqli_num_rows($sql)) {
								$select = '<select id="branch" class="field" name="course" required><option selected disabled value=""> -- Select a Batch -- </option>';
					...
					<tr>
						...
						<td class="style1">
							<input type="text" class="field" name="hr" required="true" placeholder="Enter No of Hrs">
						</td>
					</tr>
					<tr style="height:15px"></tr>
					<tr>
					...
					<tr>
						<td></td>
						<td>
							<button type="submit" class="btn btn-primary" name="submit" style=" position: absolute;"> Assign </button>
						</td>
						...
						<tr>
							...
							?>
								...
								<td>
									...
									<a href="Lecture/delete_assign_f.php?id=<?php echo $row['id']; ?>" class="btn btn-xs btn-danger">Remove
										<i class="feather icon-clock m-t-10 f-16 "></i>
									</a>
								</td>
							<?php } else{ ?>
