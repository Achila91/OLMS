...
if (isset($_GET['editid'])) {
    $cid = $_GET['editid'];
        ...
        $query = "UPDATE lec_pay SET finalize = NULL Where id='$cid'";
        mysqli_query($con, $query);
        echo "<script>alert('Lecture payment rolled back successfully!');</script>";
        echo "<script>window.location.href ='index.php?tab=rollback_f'</script>";
    } 
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <h3>Rollback Payments</h3>
        ...
        <table class="table table-striped table-bordered" id="" width="96%" cellspacing="0">
            ...
            $ret = mysqli_query($con, "select r.f_name as fname, r.l_name as lname, l.*, c.pay_hr from lec_pay l, lecture_reg r, c_assign c where c.id=l.as_id and l.l_name=r.f_name and finalize='Approved' and approve IS NULL and paid_for like '$mydate%'");
            ...
            ?>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><a href="index.php?tab=rollback_f&&editid=<?php echo $row['id']; ?>" class="btn btn-xs btn-danger">Rollback<i class="feather icon-clock m-t-10 f-16 "></i></a>
                        </td>
                    </tr>
