...
?>
  ...
  $ret = mysqli_query($con, "select count(id) as id5 from c_assign where l_name='$lname' and hr>0");
  $row4 = mysqli_fetch_array($ret);

  $ret = mysqli_query($con, "select count(id) as id6 from t_time where approval='Approved' and le_name='$lname' and (MONTH(rdate) = MONTH(CURRENT_DATE()) and YEAR(rdate) = YEAR(CURRENT_DATE()))");
  $row3 = mysqli_fetch_array($ret);

  $ret = mysqli_query($con, "select count(id) as id7 from t_time where approval='Not Approved' and le_name='$lname' and (MONTH(rdate) = MONTH(CURRENT_DATE()) and YEAR(rdate) = YEAR(CURRENT_DATE()))");
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
      ...
      <div>
        ...
        <h3 style="color: black;padding-left:20%;margin-bottom:5%">Dashboard</h3>
          <div class="container-fluid">
      ...
      <div class="container" style="display: none; width: 80%; padding-left:10%;" id="moreinfo1">
        ...
        <table class="table table-striped table-bordered" width="96%" cellspacing="0">
          ...
          <?php
          $ret = mysqli_query($con, "select * from t_time where approval='Approved' and le_name='$lname' and (MONTH(rdate) = MONTH(CURRENT_DATE()) and YEAR(rdate) = YEAR(CURRENT_DATE()))");
      ...
      <div class="container" style="display: none; width: 80%; padding-left:10%;" id="moreinfo2">
        ...
        <table class="table table-striped table-bordered" id="dataTable" width="96%" cellspacing="0">
          ...
          <?php
          $ret = mysqli_query($con, "select * from t_time where approval='Not Approved' and le_name='$lname' and (MONTH(rdate) = MONTH(CURRENT_DATE()) and YEAR(rdate) = YEAR(CURRENT_DATE()))");
      ...
      <div class="container" style="display: none; width: 80%; padding-left:10%;" id="moreinfo3">
        ...
        <table class="table table-striped table-bordered" width="96%" cellspacing="0">
          ...
          <?php
          $ret = mysqli_query($con, "select * from c_assign, student_course_batch where l_name='$lname' and hr>'0' and student_course_batch.batch_remarks=c_assign.c_name");
