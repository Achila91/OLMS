            ...
            <form method="post">
              ...
              <td >     <input type="text" id="field"  name="tlecture"  onclick="date()" placeholder="00:00:00"/></div></td>     -->
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="coverage" class="field" required value="<?php echo $row['coverage']; ?>"></textarea>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <button type="submit" class="btn btn-primary" name="submit" style="width: 90px;"> Update</button>
                        </td>
