...
$head_password = "1212@Knuwara";//change
$head_database = "ectc_lec";//change
...
//Connection3
	...
	$con = mysqli_connect($head_hostname,$head_user,$head_password,$head_database);   //create connection
